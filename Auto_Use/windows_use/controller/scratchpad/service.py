...
class ScratchpadService:
    def __init__(self, cli_mode: bool = False, session_id: str = None, minion_mode: bool = False):
        ...
        """
        # Walk up two levels (controller/scratchpad -> windows_use) to locate the package root
        ...
        if cli_mode and session_id:
            self.scratchpad_dir = os.path.join(windows_use_dir, "scratchpad", subdir, session_id)
        else:
            self.scratchpad_dir = os.path.join(windows_use_dir, "scratchpad", subdir)
